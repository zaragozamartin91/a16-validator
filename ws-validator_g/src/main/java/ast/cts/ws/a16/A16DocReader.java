...
public class A16DocReader {
    ...
    private A16DocReader(InputStream fileStream, int nameCol, int typeCol, String colDelim, String inputName, String outputName, boolean lenientRead, int subtitleRowCount) {
